...
<main>
  ...
  <section class="products">
    ...
    $query="select id, name, data, price,type from images where type='jacket'";
...
$query="select id, name, data, price,type from images where type='pant'";
    $result= mysqli_query($conn,$query);
...
$query="select id, name, data, price,type from images where category='men' and type='shirt'";
    $result= mysqli_query($conn,$query);
